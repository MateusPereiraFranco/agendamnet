...
export default function AgendaInterativa({
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-3">
        ...
        <div className="md:col-span-2">
          ...
          <input
            ...
            className="w-full p-2 border rounded outline-none focus:ring-2 focus:ring-blue-500 dark:text-gray-100"
          />
        </div>
        ...
        <div className="md:col-span-3">
          ...
          <input
            ...
            className="w-full p-2 border rounded outline-none focus:ring-2 focus:ring-blue-500 dark:text-gray-50"
          />
        </div>
        ...
        <div className="md:col-span-1 flex items-end justify-end gap-2 pb-1">
          <button
            ...
            className="p-2 bg-green-600 text-white dark:text-gray-100 rounded hover:bg-green-700 flex-1 flex justify-center"
          >
            <Check size={20} />
          </button>
          <button
            onClick={cancelarFormulario}
            className="p-2 bg-red-100 dark:bg-red-400 text-red-700 dark:text-red-50 rounded hover:bg-red-200 flex-1 flex justify-center"
          >
            <X size={20} />
          </button>
        </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-900 p-4 rounded-xl shadow-sm border border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-4">
        <button
          onClick={() => mudarDia(-1)}
          className="flex items-center gap-1 px-3 py-2 bg-gray-100 dark:bg-gray-800 rounded hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-100 font-medium w-full sm:w-auto justify-center"
        >
          <ChevronLeft size={20} /> Anterior
        </button>

        <div className="flex items-center gap-2 font-bold text-lg text-gray-800 dark:text-gray-100">
        ...
        <button
          onClick={() => mudarDia(1)}
          className="flex items-center gap-1 px-3 py-2 bg-gray-100 dark:bg-gray-800 rounded hover:bg-gray-200 text-gray-700 dark:text-gray-100 font-medium w-full sm:w-auto justify-center"
        >
      ...
      <div className="bg-blue-50 bg-gray-50 dark:bg-gray-900 p-4 rounded-xl border border-blue-100 flex items-center gap-3">
        ...
        <label className="text-sm font-bold text-blue-800 dark:text-blue-300 uppercase">
          Agenda de:
        </label>
                          ...
                          {ag.status === "agendado" && (
                            <>
                              <button
                                ...
                                className="p-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-100 rounded hover:bg-blue-50 hover:text-blue-600 transition-colors"
                                title="Editar"
                              >
                                <Edit2 size={18} />
                              </button>
                              <button
                                ...
                                className="p-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-100 rounded hover:bg-green-50 hover:text-green-600 transition-colors"
                              ...
                              <button
                                ...
                                className="p-2 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-100 rounded hover:bg-red-50 hover:text-red-600 transition-colors"
